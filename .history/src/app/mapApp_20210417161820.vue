      ...
      >
        ...
        >
          <li
            ...
            :style="bottomShow != 2 ? { width: '26%' } : { width: '33%' }"
          >
            <div
              class="buttonDiv"
              :style="
  ...
  methods: {
    ...
    changeCurmb(val, type) {
      ...
      let json = [],
        flag = false;
      if (type == "1") {
        json = { name: "全球" + val.name, type: val.type };
      } else {
        json = { name: val.name, type: val.type };
      }
      if (type == "1") {
