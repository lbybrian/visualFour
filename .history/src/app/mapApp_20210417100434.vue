<template>
  <div style="" class="example">
    ...
    <div class="bottombar">
    <div class="bottomBox" :style="bottomTab != 2 ? {backgroundImage:'url('+background_5+')'} :{backgroundImage:'url('+background_3+')'}">
        <ul class="bottomUl" :style="bottomTab != 2 ? {marginLeft: '18%',width: '64%'} :{marginLeft: '31%',width: '38%'}">
