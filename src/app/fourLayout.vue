<template>
  <div class="threeLayout">
    ...
    <el-row :gutter="20" class="threeEl">
      <el-col :span="12">
        <DynamicItem ref="item3" @setComponent="openSetComponentDialog" :currentStep="currentStep"
          :lastStatus="lastStatus"></DynamicItem>
      </el-col>
      <el-col :span="12">
        <DynamicItem ref="item4" @setComponent="openSetComponentDialog" :currentStep="currentStep"
          :lastStatus="lastStatus"></DynamicItem>
      </el-col>
    </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      exampleReturnData() {
        return [this.$refs.item1.returnData(), this.$refs.item2.returnData(), this.$refs.item3.returnData(), this.$refs
          .item4.returnData()
        ]
      }
    },
